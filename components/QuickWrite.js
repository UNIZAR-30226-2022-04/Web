	...
	return (
		<div className="storyBox">
			<form onSubmit={onSubmit}>
				...
				<div className="centered">
					<textarea
						className={`storyWrite text-2xl font-arial inline-flex flex-col h-48 w-6/12 ${
							handicap == "reves" ? "font-reverse" : ""
						}${handicap == "ciego" ? "font-blank" : ""}`}
						type="password"
						required={true}
						maxLength={maxChar}
						value={currentText}
				...
				<div className="clickable-item centered">
					<input
						className="bg-blue-400 w-32 rounded-xl"
						type="submit"
						value="Enviar parrafo"
					/>
				</div>
			</form>
		</div>
