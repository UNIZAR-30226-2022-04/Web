        ...
        <div className='flex flex-row h-full justify-between items-center bg-gray-200 px-2 rounded-lg'>
            <div className='flex flex-row'>
                {faces ? (
                    ...
                    <>
                        <h1 className='font-graduate w-auto xl:text-3xl text-sm text-verde_letras font-bold'>{index+1}º</h1>
                        {index == 0 ? (
                            <>
                ...
                <h1 className='font-graduate xl:w-32 w-10 xl:text-2xl text-sm text-verde_letras'>{person.username}</h1>
            </div>
            
            
            <div className='flex flex-row items-center space-x-4'>
                <h1 className='font-graduate pl-24 xl:text-2xl text-sm text-verde_letras text-right'>x {person.stars}</h1>
                <div>
