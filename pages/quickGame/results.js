    ...
    <Layout data={layoutInfo}>
        <div className="flex flex-col w-screen">
              ...
              <div>
                ...
                <div>
                  ...
                  <div className="w-1/12"/>
                    ...
                    <div className="text-4xl text-white font-bold ml-10">+{results.coins}</div>
          ...
          <div className='text-center'>
            <input type="button" className="clickableItem rounded-xl bg-green-800 text-white p-2 border-2 border-white text-center font-bold" value="Recoger" onClick={() => router.push("/quickGame")}/>
          </div>
