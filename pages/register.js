		...
		<div className="background h-screen w-screen flex flex-col items-center justify-center">
			...
			<div className="flex flex-row items-center justify-center">
				<form
					...
					onSubmit={(e) =>
						onSubmit(e, name, mail, password, passwordR, router)
					}
				>
					...
					<div className="flex flex-col w-96 space-y-2">
						...
						<button
							className="commonButton bg-verde_top mt-2"
							type="submit"
						>
							Crear cuenta
						</button>
			...
			<button
				className="absolute bottom-0 left-0 m-10 commonButton bg-verde_top "
